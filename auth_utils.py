...
class AuthJwtCsrf():
    ...
    secret_key = JWT_KEY
    def generate_hashed_pw(self,passward) -> str:
        return self.pwd_ctx.hash(passward)
    def veriify_pw(self,plain_pw,hashed_pw) -> bool:
    ...
    def decode_jwt(self,token) -> str:
        try:
            ...
            raise HTTPException(
                status_code=401,detail="The JWT code is expired"
            )
